...
class ModernVocabularyApp(tk.Tk):
    ...
    def create_widgets(self):
        ...
        ttk.Label(input_frame, text="Английское слово:").grid(row=0, column=0, padx=10, pady=10)
        self.eng_entry = ttk.Entry(input_frame, style='Entry.TEntry', width=25)
        self.eng_entry.grid(row=0, column=1, padx=10, pady=10)
        
        ttk.Label(input_frame, text="Русский перевод:").grid(row=1, column=0, padx=10, pady=10)
